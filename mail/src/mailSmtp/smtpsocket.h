 ...
 * \param  sock            open network socket
 * \return null-terminated string containing received data (must be freed by caller), or nullptr
*/
 ...
 * \param  sock            open network socket
 * \param  debuglog        file handle to write debugging information to (nullptr for no debugging)
